(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '共 {0} 筆',                                                        // text when all options are visible / false for no info text
      ...
      infoTextEmpty: '已選取的關鍵字',                                                        // when there are no options present in the list
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '   <select multiple="multiple" class="option-list" ></select>' +
        ' </div>' +
